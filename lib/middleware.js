...
function middlewareWorker(port, middlewarelist, pathToFileWithCustomMiddleware){
	...
	var installedMiddleware = makeMiddlewareFunctionList(pathToFileWithCustomMiddleware, builtInMiddleware);
	var storage = {};
...
function makeMiddlewareFunctionList(pathToFileWithCustomMiddleware, builtInMiddleware){
